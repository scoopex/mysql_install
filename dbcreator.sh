...
DROP USER '${DBUSER_PREFIX}_app'@'localhost';
DROP USER '${DBUSER_PREFIX}_adm'@'localhost';
EOF
)"
fi
...
CREATE USER '${DBUSER_PREFIX}_app'@'localhost' IDENTIFIED BY '${APP_PASSWORD}';
GRANT USAGE ON * . * TO '${DBUSER_PREFIX}_app'@'%' IDENTIFIED BY '${APP_PASSWORD}' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS $MAX_CONN_APP ;
GRANT USAGE ON * . * TO '${DBUSER_PREFIX}_app'@'localhost' IDENTIFIED BY '${APP_PASSWORD}' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS $MAX_CONN_APP ;
REVOKE ALL PRIVILEGES ON *  . *  FROM '${DBUSER_PREFIX}_app'@'%';
REVOKE ALL PRIVILEGES ON *  . *  FROM '${DBUSER_PREFIX}_app'@'localhost';
CREATE USER '${DBUSER_PREFIX}_adm'@'%' IDENTIFIED BY '${ADM_PASSWORD}';
CREATE USER '${DBUSER_PREFIX}_adm'@'localhost' IDENTIFIED BY '${ADM_PASSWORD}';
GRANT USAGE ON * . * TO '${DBUSER_PREFIX}_adm'@'%' IDENTIFIED BY '${ADM_PASSWORD}' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS $MAX_CONN_ADM ;
GRANT USAGE ON * . * TO '${DBUSER_PREFIX}_adm'@'localhost' IDENTIFIED BY '${ADM_PASSWORD}' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS $MAX_CONN_ADM ;
REVOKE ALL PRIVILEGES ON *  . *  FROM '${DBUSER_PREFIX}_adm'@'%';
REVOKE ALL PRIVILEGES ON *  . *  FROM '${DBUSER_PREFIX}_adm'@'localhost';
EOF
)"
...
GRANT SELECT , INSERT , UPDATE , DELETE , EXECUTE
 ON \`$db\` . * TO '${DBUSER_PREFIX}_app'@'localhost' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS $MAX_CONN_APP ;
...
GRANT SELECT , INSERT , UPDATE , DELETE , CREATE , DROP , INDEX , ALTER , CREATE TEMPORARY TABLES , LOCK TABLES ,
 CREATE VIEW , SHOW VIEW , CREATE ROUTINE, ALTER ROUTINE, EXECUTE, EVENT, TRIGGER
 ON \`$db\` . * TO '${DBUSER_PREFIX}_adm'@'localhost' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS $MAX_CONN_ADM ;
EOF
)"
done
...
GRANT SELECT , INSERT , UPDATE , DELETE , EXECUTE
 ON \`$db\` . * TO '${DBUSER_PREFIX}_app'@'localhost' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 
 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS $MAX_CONN_APP ;
...
GRANT SELECT , INSERT , UPDATE , DELETE , CREATE , DROP , INDEX , ALTER , CREATE TEMPORARY TABLES , LOCK TABLES ,
 CREATE VIEW , SHOW VIEW , CREATE ROUTINE, ALTER ROUTINE, EXECUTE, EVENT, TRIGGER
 ON \`$db\` . * TO '${DBUSER_PREFIX}_adm'@'localhost' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 
 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS $MAX_CONN_ADM ;
EOF
)"
done
